# Glossário - Projeto Bizzu

| Termo        | Definição |
|--------------|-----------|
| **Repositório** | Espaço dentro do perfil do usuário onde é possível armazenar materiais acadêmicos como documentos, códigos, imagens ou arquivos de texto. Pode ser publicado com título, descrição e categorias. |
| **Postagem** | Conteúdo criado por um usuário no feed da plataforma, podendo conter textos ou imagens, além de permitir curtidas e comentários. As postagens são categorizadas por curso, matéria, período e tecnologia. |
| **Publicação** | Ato de compartilhar um conteúdo, seja uma postagem no feed ou um repositório. Inclui informações como data, curtidas e comentários. |
