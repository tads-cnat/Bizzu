...
| Administrador da comunidade  | É um usuário com permissões avançadas, responsável por garantir que tudo esteja certo a respeito das comunidades, por meio da criação, edição ou exclusão de uma comunidade, também possui a possibilidade de criar avisos informativos na comunidade, esses avisos ficam marcados como se a comunidade que tivesse criado (como por exemplo: "post criado pela coumnidade de TADS"). | Pode criar uma ou mais comunidades de qualquer curso. / Pode editar as comunidades as quais pertencem a ele./ Cria avisos informativos com o intuito de passar alguma informação para as pessoas que acessam a comunidade. / Pode a qualquer momento excluir uma comunidade que ele administra.|
