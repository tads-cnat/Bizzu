...
| F15 | Visualiza todas as comunidades  | Possibilidade de visualizar as comunidades que existem no sistema. |
| F16 | Monitora denúncia | O moderador poderá monitorar as denúncias feitas a um postagem.|
| F17 | Realiza denúncia | O usuário tem a capacidade de realizar denúncias em uma postagem, caso acredite que o conteúdo da mesma seja imprópria para o site. |
| F18 | Login na plataforma | É necessário o fornecimento de um e-mail/Nome de usuário e senha para que assim ele tenha acesso ao sistema.| 

## 9. Requisitos não-funcionais

| Código              |  Nome               |          Descrição  |  Categoria          |  Classificação      |
| :-----------------: | :-----------------: | :-----------------: | :-----------------: | :-----------------: |
| NF01 | Utilização python com django rest framework, typescript, react, tailwind, figma, docker e postgres | Para o backend será utilizado django rest framework com python e postgres como banco de dados Para o template utilizar react com tailwind para estilização.Na parte de prototipagem, o figma. | Desenvolvimento | Obrigatório  |
...
| NF05 | Autenticação e autorização de acesso | A autenticação é necessária para acessar uma conta pessoal, utilizando e-mail e senha. Além disso, a autorização varia conforme o papel do usuário, sendo diferente para usuários comuns e moderadores, o que influencia as informações exibidas no sistema |
