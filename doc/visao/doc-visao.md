...
| F05 | Criar e personalizar perfil pessoal | Ao criar uma conta é possível colocar informações pessoais para efetivação desta criação. Como: 
Nome(obrigatório), foto(opcional), descrição(opcional), informações da área acadêmica, profissional(opcional)  e comunidade do curso que o mesmo faça parte ou deseja fazer parte futuramente(obrigatório)o perfil continua personalizável após o cadastro. |
...
| F10 | Seguir perfis e comunidades | Possibilidade de filiação a alguma comunidade após a criação da conta e seguir perfis pessoais de outros usuários.
No perfil pessoal e no perfil da comunidade é possível visualizar a quantidade de pessoas que seguem a conta, e se tratando apenas do perfil pessoal quantas pessoas aquele usuário segue | 
