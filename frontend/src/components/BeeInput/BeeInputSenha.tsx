...
import cadeado from "/Lock.svg"
import olho from "/Eye.svg"
import olhofechado from "EyeSlash.svg"
...
export default function BeeInputUsuario(props: IBeeInput): JSX.Element{
        ...
        return (
                ...
                <div className={styles.inputcontainer}>
                        ...
                        <img src={cadeado} className={styles.icones} alt="icone cadeado"></img>
                        <img src={olho} className={styles.iconeOlho} alt="icone olho"></img>
