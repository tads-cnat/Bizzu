...
const BeePerfilSidebar: React.FC = () => {
  ...
  if (!usuario) {
    return <div className="text-center py-8 text-gray-500">Usuário não encontrado</div>
  }
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: usuario.banner ? `url(http://localhost:8000${usuario.banner})` : `url(/banner.png)`,
        ...
        <div className="p-4">
          <h2 className="text-xl font-semibold text-[#333333] font-poppins mb-2">{usuario.nome}</h2>
